...
/**
 * Compuesta por un numerador y un denominador. Constructor para 1 parámetro y 2 parámetros. Incluye
 * funciones para dividir, multiplicar, sumar y restar. toString modificado.
 * 
...
public class Fraccion {
  ...
  /**
   * Crea un objeto Fraccion al indicarle solo un número. El numerador será el número introducido y
   * el denominador 1.
   * 
   * @param numerador Numerador de una fracción o división
   */
   ...
   * @return Fraccion Objeto fracción con el valor de la multiplicación de las 2 fracciones que se
  ...
  /**
   * Devuelve el resultado de la suma entre 2 fracciones
   * 
   * @param f Sumando 2
   * @return Fraccion Objeto fracción con el valor de la suma
   */
  ...
  /**
   * Devuelve el resultado de la resta entre 2 fracciones
   * 
   * @param f Sustraendo
   * @return Fraccion Objeto fracción con el valor de la resta
   */
