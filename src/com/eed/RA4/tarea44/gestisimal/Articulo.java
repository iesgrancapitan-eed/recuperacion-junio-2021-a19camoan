 ...
 * puede modificarse el código de un artículo, pero si el resto de las propiedades. Podremos mostrar
 * el artículo, por lo que necesita una representación del artículo en forma de cadena (toString).
 * 
...
public class Articulo {
   ...
   * devulve codigo
   * 
   * @return codigo número entero para identificar un artículo
   */
  int getCodigo() {
    return codigo;
  }
   ...
   * 
   * @return precioVenta Precio al que se vende un artículo
   */
   ...
   * 
   * @return descripcion Descripción de un artículo
   */
   ...
   * 
   * @return numeroUnidades Número de unidades disponibles de un artículo
   */
   ...
   * 
   * @return stockSeguridad Stock mínimo permitido de un artículo
   */
   ...
   * 
   * @return stockMaximo Stock máximo de un artículo
   */
  int getStockMaximo() {
    return stockMaximo;
  }
